...
exports.drawIceCreamOptions = drawIceCreamOptions;
exports.drawCounter = drawCounter;
exports.drawSidebar = drawSidebar;
function drawFace(crc2, x, y, radius, happy) {
    crc2.beginPath();
...
function drawIceCreamOptions(crc2) {
    const options = [
